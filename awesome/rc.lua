...
--autostart, comma-separated entries
...
-- fuck it all lmao everything is floating
...
globalkeys = mytable.join(
    ...
    -- Take a screenshot
    awful.key({ altkey }, "p", function() os.execute("scrot -s ~/Pictures/%Y-%m-%d_$wx$h.png") end,
              {description = "take a screenshot", group = "hotkeys"}),
    awful.key({ modkey            }, "Shift", function() kbdcfg:next() end, {description = "switch layout", group = "hotkeys"}),
    -- X screen locker
