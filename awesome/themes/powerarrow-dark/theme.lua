...
theme.wallpaper                                 = theme.dir .. "/raspi-wall.png"
...
theme.tasklist_bg_focus                         = "#313130" --"#1A1A1A"
...
mem.widget:buttons(my_table.join(awful.button({ }, 1, function () awful.spawn.with_shell("st -e htop") end)))
...
cpu.widget:buttons(my_table.join(awful.button({ }, 1, function () awful.spawn.with_shell("st -e htop") end)))
